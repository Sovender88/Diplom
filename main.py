# Кувшинников Никита 12-я когорта - Финальный проект. Инженер по тестированию плюс
...
def get_order(track_number):
    get_order_url = configuration.URL_SERVICE + configuration.GET_ORDER_INFO_PATH + f"?t={track_number}"
...
if __name__ == "__main__":
    order = test_order_creation_and_retrieval()
    pprint.pprint(order)
'''
